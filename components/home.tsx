            ...
            <motion.div initial={{ opacity: 0, x: -100 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1 }}>
              ...
              <div className="flex items-center space-x-6 mb-12 mt-14">
                ...
                <motion.h1
                  ...
                  className="text-4xl mt-10 lg:text-7xl font-bold tracking-wider"
                  style={{
              ...
              >
                <button
                  ...
                  className=" flex items-center space-x-3  px-4 py-2 lg:px-8 lg:py-4 bg-violet-600 hover:bg-violet-700 transition-all duration-300 group"
                >
...
><div className="w-12 h-12 border-2 border-current rounded-full flex items-center justify-center group-hover:bg-violet-600 group-hover:text-white transition-all">
              ...
              <motion.div
                ...
                className="flex items-center space-x-8 mt-7 lg:mb-2 lg:space-x-8 lg:mt-16"
              >
                <div className="w-px h-9 lg:h-12 bg-white/30"></div>
                <span className="text-md lg:text-lg opacity-60 tracking-wider font-light">FOLLOW US</span>
                <div className="flex space-x-6">
                  <a
                    href="https://www.instagram.com/eutopia_architects?igsh=MTU5MjZicjNjMnFldA=="
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 lg:w-14 lg:h-14  border-2 border-violet-500/50 rounded-full flex items-center justify-center text-white/60 hover:text-white hover:border-violet-500 hover:bg-violet-500/20 transition-all duration-300 group"
                  >
                    <svg
                      width="24"
                      height="24"
              ...
              <div className="relative group cursor-pointer">
                ...
                >
                  ...
                  <div className="absolute bottom-6 left-6 text-white">
                    <h3 className="text-2xl font-bold lg:mb-2">Toni & Guy</h3>
      ...
      >
        <div className="container mx-auto lg:px-16 px-10">
          <div className="grid lg:grid-cols-4 grid-cols-2 gap-12">
            {[
              ...
              >
                ...
                <h3 className="lg:text-4xl text-2xl font-bold lg:mb-2 mb-1 text-white">{stat.number}</h3>
