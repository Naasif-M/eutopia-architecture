  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <motion.div
        ...
        className="max-w-7xl mx-auto px-16 py-24"
      >
        <div className="text-center mb-16">
          <motion.h2
            ...
            className="text-7xl font-bold tracking-wider mb-6 text-white font-serif"
          >
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
                ...
                <div className="p-16 flex flex-col justify-center">
                  ...
                  <button className="flex items-center space-x-3 text-current hover:opacity-70 transition-opacity group">
                    <span className="tracking-wider font-bold">LEARN MORE</span>
